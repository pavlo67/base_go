...
func (i *Instagram) Init(feedURL, dbKey string, testMode bool) error {
	...
	//	userID = arr[1]
	//} else {
	//	return errors.New("can't get instagram user ID from url: " + feedURL)
	//}
	//api := instagram.New(i.ID, i.Secret, i.Token, true)
	//params := url.Values{}
	...
	//	//media.Images
	//	log.Println("IS user:", media.User.Username)
	//	log.Println("IS media:", media.Images)
	//	i.items = append(i.items, media)
	//	li++
	//	if li > 2 {
	//		break
	//	}
