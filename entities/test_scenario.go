...
func OperatorTestScenario(t *testing.T, crudOp OperatorCRUD, crudCleanerOp db.Cleaner,
...
func CountTestItems(t *testing.T, crudOp OperatorCRUD, crudType Type, actor auth.Actor, expectedCount int) {
